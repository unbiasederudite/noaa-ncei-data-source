...
munich_data = LocationData("ZIP:28801")
...
location_data_file_path = munich_data.fetch_location_data(format="csv", datasetid="GHCND", startdate="2010-05-01", enddate="2010-05-01")
